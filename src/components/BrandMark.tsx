...
export const BrandMark: React.FC<BrandMarkProps> = ({
    ...
    return (
        <div
            ...
            aria-label={title}
        >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_16%,rgba(56,189,248,0.55),transparent_34%),radial-gradient(circle_at_84%_18%,rgba(245,158,11,0.34),transparent_28%),radial-gradient(circle_at_50%_88%,rgba(45,212,191,0.28),transparent_38%),linear-gradient(150deg,#11223c_0%,#0b1630_36%,#08111f_100%)]" />
            ...
            >
                ...
                <circle cx="33.1" cy="31.9" r="2.8" fill="#F59E0B" />
    ...
    return (
        <div className={`flex gap-3 ${alignment} ${className}`}>
            ...
            <div className="min-w-0">
                <div className="bg-[linear-gradient(135deg,#7dd3fc,#fde68a,#99f6e4)] bg-clip-text text-[10px] font-black uppercase tracking-[0.34em] text-transparent">
                    {subtitle}
                </div>
